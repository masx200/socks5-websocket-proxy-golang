...
使用 Go 语言开发一个支持 SOCKS5 和 WebSocket 协议的网络代理系统，实现多种协议间的灵活转发和统一接口封装。
...
- **WebSocket 客户端**：实现 WebSocket 协议客户端功能，支持通过 HTTP Headers 传递认证信息
- **WebSocket 服务端**：实现 WebSocket 协议服务端功能，支持从 HTTP Headers 解析认证信息
